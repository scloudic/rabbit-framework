...
import com.scloudic.rabbitframework.generator.builder.TableConfiguration;
...
import com.scloudic.rabbitframework.generator.builder.TableType;
...
import com.scloudic.rabbitframework.generator.mapping.type.JavaTypeResolver;
    ...
    private List<EntityMapping> introspectTables(TableConfiguration tableConfiguration) {
        ...
        for (Map.Entry<String, String> entry : sets) {
            ...
            EntityMapping.Builder builder = new EntityMapping.Builder(tableName, objectName, entityProperties,
                    configuration.getJdbcConnectionInfo().getDialect());
    ...
    public Map<String, EntityProperty> getColumns(String tableName) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                if ("no".equalsIgnoreCase(isAutoincrement)) {
