...
final class FreemarkerViewProcessor extends AbstractTemplateProcessor<Template> {
	...
	public FreemarkerViewProcessor(final javax.ws.rs.core.Configuration config, final ServiceLocator serviceLocator,
		...
		super(config, servletContext, "freemarker", getSupportedExtensions(config));
	...
	// @Inject
	// public FreemarkerViewProcessor(javax.ws.rs.core.Configuration config,
	// InjectionManager injectionManager) {
	// super(config, injectionManager.getInstance(ServletContext.class),
	// "freemarker", getSupportedExtensions(config));
	//
	// this.factory =
	// getTemplateObjectFactory(injectionManager::createAndInitialize,
	...
	// if (configuration == null) {
	// return new
	// FreemarkerDefaultConfigurationFactory(injectionManager.getInstance(ServletContext.class));
	// } else {
	// return new FreemarkerSuppliedConfigurationFactory(configuration);
	// }
	// });
