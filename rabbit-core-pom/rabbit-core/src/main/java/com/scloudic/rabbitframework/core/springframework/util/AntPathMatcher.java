...
public class AntPathMatcher implements PathMatcher {
	...
	protected boolean doMatch(String pattern, String path, boolean fullMatch,
		...
		String[] pattDirs = SpringStringUtils.tokenizeToStringArray(pattern, this.pathSeparator, this.trimTokens, true);
		String[] pathDirs = SpringStringUtils.tokenizeToStringArray(path, this.pathSeparator, this.trimTokens, true);
