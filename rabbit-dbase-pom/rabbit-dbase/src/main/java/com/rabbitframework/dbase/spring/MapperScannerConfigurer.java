...
public class MapperScannerConfigurer implements
    ...
    public void postProcessBeanDefinitionRegistry(
        ...
        scanner.setRabbitDbaseFactoryBeanName(this.rabbitDbaseFactoryBeanName);
    ...
    private void processPropertyPlaceHolders() {
        ...
        if (!prcs.isEmpty()
            ...
            this.rabbitDbaseFactoryBeanName = updatePropertyValue(
                    "rabbitDbaseFactoryBeanName", values);
        }
    }
