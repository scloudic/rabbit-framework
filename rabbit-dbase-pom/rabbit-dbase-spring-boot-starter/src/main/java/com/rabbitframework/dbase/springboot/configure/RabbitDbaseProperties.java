...
@ConfigurationProperties(prefix = RabbitDbaseProperties.RABBIT_DBASE_PREFIX)
public class RabbitDbaseProperties {
    public static final String RABBIT_DBASE_PREFIX = "rabbit.dbase";
