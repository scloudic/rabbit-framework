...
import com.rabbitframework.jade.spring.MapperScannerConfigurer;
...
@Configuration
@AutoConfigureAfter(RabbitJadeAutoConfiguration.class)
public class MapperScannerAutoConfiguration implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        builder.addPropertyValue("rabbitJadeFactoryBeanName", "rabbitJadeFactory");
        registry.registerBeanDefinition("rabbitJadeMapperScannerConfigurer", builder.getRawBeanDefinition());
    }
}