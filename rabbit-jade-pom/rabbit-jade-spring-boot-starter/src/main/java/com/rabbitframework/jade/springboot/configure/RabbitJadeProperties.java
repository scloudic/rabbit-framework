...
@ConfigurationProperties(prefix = RabbitJadeProperties.RABBIT_JADE_PREFIX)
public class RabbitJadeProperties {
    public static final String RABBIT_JADE_PREFIX = "rabbit.jade";
