...
public class RabbitJbatisAutoConfiguration {
    ...
    private final RabbitJbatisProperties rabbitJadeProperties;
    private final ApplicationContext applicationContext;

    public RabbitJbatisAutoConfiguration(ApplicationContext applicationContext,
                                         RabbitJbatisProperties rabbitJadeProperties) {
    ...
    public DataSourceFactory dataSourceFactory() {
        RabbitJbatisProperties.DataSourceFactoryType dataSourceFactoryType = rabbitJadeProperties
    ...
    public RabbitJbatisFactory rabbitJbatisFactory() throws Exception {
        ...
        rabbitJbatisFactoryBean.setEntityPackages(rabbitJadeProperties.getEntityPackages());
        rabbitJbatisFactoryBean.setMapperPackages(rabbitJadeProperties.getMapperPackages());
