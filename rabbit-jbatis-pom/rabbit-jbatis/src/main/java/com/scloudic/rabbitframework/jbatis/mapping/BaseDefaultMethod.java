...
public enum BaseDefaultMethod {
    ...
    DELETEBYPARAMS("deleteByParams", "根据where条件删除", "delete from %s${tableSuffix} where 1=1 ", DeleteByParams.class, false),
    ...
    SELECTONEBYPARAMS("selectOneByParams", "根据where条件查询唯一", "select ${showColumns} from %s${tableSuffix} where 1=1 ", SelectOneByParams.class, false),
    SELECTBYPARAMS("selectByParams", "根据where条件查询", "select ${showColumns} from %s${tableSuffix} where 1=1 ", SelectByParams.class, false),
    SELECTCOUNTBYPARAMS("selectCountByParams", "根据where条件查询总数", "select count(1) from %s${tableSuffix} where 1=1 ", SelectCountByParams.class, false),
    ...
    SELECTPAGEBYPARAMS("selectPageByParams", "根据where条件分页查询", "select ${showColumns} from %s${tableSuffix} where 1=1 ", SelectPageByParams.class, false),
