package com.scloudic.rabbitframework.jbatis.log;
    ...
    public Object invoke(Object proxy, Method method, Object[] params)
        ...
        try {
            if ("prepareStatement".equals(method.getName())) {
                if (isDebugEnabled()) {
                    debug(statementLog.getName() + " ==> Preparing: " + removeBreakingWhitespace((String) params[0]));
                }
                ...
                if (isDebugEnabled()) {
                    debug(statementLog.getName() + " ==> Preparing: "
